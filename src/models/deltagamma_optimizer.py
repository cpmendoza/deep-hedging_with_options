...
from src.data.full_data_loader_delta_gamma import *
from src.models.deltagamma_notrade_region import train_network
from src.models.deltagamma_notrade_region import network_inference

def deltagamma_agent(config_file_simulation,config_file_agent):
    ...
    # 2) First layer of DG optmizer hyperparameters 
    ...
    # 2) Second layer of DG optmizer hyperparameters
    ...
    initial_point     = 2.7                                 # Initial point to start the algorithm
    ...
    print("--- Delta-gamma no-trade region trained and stored in ../models/.. ---")
    ...
    deltas,latent, portfolio, constraint, name = network_inference(network, nbs_point_traj, batch_size, nbs_input, nbs_units, nbs_assets,
                                                            ...
                                                            underlying_train, underlying_test, HO_train, HO_test, cash_flows_train,
                                                                ...
                                                                nbs_latent_spc, lambda_auto, rebalancing_const, initial_point)
    
    print("--- Delta-gamma hedging startegy stored in ../results/Training/.. ---")
